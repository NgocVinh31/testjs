...
// vd như câu trên khi hàm sayname chạy đến return là hàm hết chạy trừ khi gọi lại hàm nhưng t vẫn truy xuất được biến name trong hàm sayname và in ra màn hình thông quan hàm sayhi
// hiểu đơn giản là phần chỗ return sayhi ý 
// khi ta chạy hàm sayname thì ta chả thấy in ra cái gì đúng không
// rồi ta cho biến say vào rồi dùng biên say() để chạy thì in ra được 
// => đó là closure cho phép ta truy xuất mọi thứ trong hàm con khi chạy xong hàm 
