...
// Math.max()// là truyên các số vào trong ngoặc rồi nó sẽ trả về số lớn nhất
// Math.min() // cũng giống như max nhưng ngoặc lại là trả về số nhỏ nhất
Math.pow(3,5)//là số bình phương số 3 là số cần bình 
