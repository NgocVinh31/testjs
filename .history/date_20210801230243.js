...
const birthday =new Date(2021,06,06,12,56,23,60);
...
//get day(ngày trong tuần) nó cũng giống như month tính từ 0 đến 6  0 tương đương là chủ nhật ,1 là thứ 2, 2 là thứ ba,...    
...
//các hàm set cũng giống như vậy
//setfullyear rồi này nọ
//các hàm trong date
const now=new Date();
console.log(now.toDateString())// in ra Sun Aug 01 2021
console.log(now.toTimeString())// in ra 22:11:56 GMT+0700 (Giờ Đông Dương)
console.log(now.toLocaleDateString("vi-VI"))// in ra 1/8/2021
console.log(now.toISOString())//in ra 2021-08-01T15:29:17.539Z 


// setTimeout và setInterval
//setTimeout là cứ hết thời gian đặt thì nó sẽ chạy //vd sau 1s nó sẽ chạy nhưng nó chỉ chạy 1 lần
//setInterval cái này sẽ chạy vĩnh viễn sau hết thời gian vd cứ sau 1 giây nó sẽ chạy và nó chạy mãi mãi
...
const time1=setInterval(function(){
    console.log("vinh");
}, 3000);//nó vẫn chạy nhá vì nó không phải là cách gọi như function
// nhưng nếu để nó chạy lien tục thì sẽ rất tốn tài nguyên lên ta thường cho nó vào biến rồi dùng hàm clearinterval chú ý cũng có hàm cleartimeout
clearInterval(time1);//hàm này nó sẽ dừng lại interval
